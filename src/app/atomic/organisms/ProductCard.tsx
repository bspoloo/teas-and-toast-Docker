...
function ProductCard({ id, name, image, category,singleRecipeRoute }: ProductCardProps) {
    return (
        ...
        <div className=" flex flex-col items-center border border-gray-200 rounded-2xl text-center cursor-pointer hover:bg-[#DBDFD0] hover:shadow-lg hover:scale-105 transform transition-all duration-300 ease-in-out bg-[#F9F9F7]">
